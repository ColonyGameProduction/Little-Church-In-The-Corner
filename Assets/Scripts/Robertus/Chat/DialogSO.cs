...
/// <summary>
/// Scriptable object untuk dialog. Ini angggapannya satu renungan, isinya ada banyak teks dialog untuk satu renungan (karena kalau cuma 1 teks doang, bakal panjang banget, jadi dipisah per chat bubble).
/// </summary>
